...
public class PantallaPartidaTerminada extends JFrame {
    ...
    public PantallaPartidaTerminada(GestorPantallas gestorPantallas, String nombre, int puntajePartida, int tamanioMatriz, String nivel) {
        ...
        configurarPantalla();
        crearTituloGameOver();
        crearLblNombre(nombre);
        crearLblPuntaje(puntajePartida);
        crearBtnJugarDeNuevo(nombre, tamanioMatriz, nivel);
        crearBtnVolverMenu();
    }
	...
	private void crearLblNombre(String nombre) {
        JLabel lblNombre = new JLabel("Jugador: " + nombre, SwingConstants.CENTER);
	...
	private void crearLblPuntaje(int puntajePartida) {
        JLabel lblPuntaje = new JLabel("Puntaje Final: " + puntajePartida, SwingConstants.CENTER);
	...
	private void crearBtnJugarDeNuevo(String nombre, int tamanioMatriz, String nivel) {
